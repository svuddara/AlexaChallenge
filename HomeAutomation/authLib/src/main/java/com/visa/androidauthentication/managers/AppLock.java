...
public abstract class AppLock {
    ...
    /**
     * EXTRA_TYPE, uses to pass to the {@link com.visa.androidauthentication.managers.AppLockActivity}
     ...
     * take into account for the {@link com.visa.androidauthentication.PinActivity}. These activities
     * will not log the last opened time, will not launch the
     * {@link com.visa.androidauthentication.managers.AppLockActivity} etc...
     */
    ...
    /**
     * Get logo resource id used by {@link com.visa.androidauthentication.managers.AppLockActivity}
     */
    public abstract int getLogoId();

    /**
     * Set logo resource id used by {@link com.visa.androidauthentication.managers.AppLockActivity}
     */
    public abstract void setLogoId(int logoId);

    /**
     * Get the forgot option used by {@link com.visa.androidauthentication.managers.AppLockActivity}
     */
    public abstract boolean shouldShowForgot();

    /**
     * Set the forgot option used by {@link com.visa.androidauthentication.managers.AppLockActivity}
     */
    ...
    /**
     * Enable the {@link com.visa.androidauthentication.managers.AppLock} by setting
     * {@link com.visa.androidauthentication.managers.AppLockImpl} as the
     * {@link com.visa.androidauthentication.interfaces.LifeCycleInterface}
     */
    public abstract void enable();

    /**
     * Disable the {@link com.visa.androidauthentication.managers.AppLock} by removing any
     * {@link com.visa.androidauthentication.interfaces.LifeCycleInterface}
     */
    ...
    /**
     * Disable the {@link com.visa.androidauthentication.managers.AppLock} by removing any
     * {@link com.visa.androidauthentication.interfaces.LifeCycleInterface} and also delete
     ...
     * Set in {@link com.visa.androidauthentication.interfaces.LifeCycleInterface#onActivityPaused(Activity)}
     * and {@link com.visa.androidauthentication.interfaces.LifeCycleInterface#onActivityResumed(Activity)}
     */
     ...
     * {@link com.visa.androidauthentication.encryption.Encryptor} class.
     */
    ...
    /**
     * Evaluates if:
     * - we are already into the {@link com.visa.androidauthentication.managers.AppLockActivity}
     * - the passcode is not set
     * - the timeout didn't reached
     * If any of this is true, then we don't need to start the
     * {@link com.visa.androidauthentication.managers.AppLockActivity} (it returns false)
