...
import com.visa.androidauthentication.encryption.Encryptor;
...
public class AppLockImpl<T extends AppLockActivity> extends AppLock implements LifeCycleInterface {
    ...
    /**
     * The activity class that extends {@link com.visa.androidauthentication.managers.AppLockActivity}
     */
