 ...
 * {@link TicketViewFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link TicketViewFragment#newInstance} factory method to
...
//    private Spass mSpass;
    ...
    private static final String TAG = TicketViewFragment.class.getName();
...
//    };
    ...
    private void proceedToHomePage(){
        NavigationUtils.navigateToFragment(getActivity(), new TicketReceiptFragment(), R.id.fragment_container, TAG, true);
    }
